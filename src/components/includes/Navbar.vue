              ...
              <ul class="dropdown-menu">
                <li>
                  <small>
                    ...
                    By clicking any share button below your graph will be made
                    publically available to anybody with the link (no login
                    required). This permission can be revoked in your dashboard.
                  </small>
                </li>
                <!-- <li>
  ...
  methods: {
    ...
    login() {
      ...
      const authenticator = new Netlify(
        process.env.VUE_APP_NETLIFY_SITE_ID
          ? { site_id: process.env.VUE_APP_NETLIFY_SITE_ID }
          : {}
      );
